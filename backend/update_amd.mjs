...
const json = readFileSync('C:/Users/murra/portal-reportes/AMD.json', 'utf8');
JSON.parse(json); // valida -- lanza error si JSON invalido
...
console.log('Verificacion BD:', verify.rows);
