...
const CLASIFICACION = {
  ...
  ABNB:  { sector: 'Consumer Discretionary',  industria: 'Hotels, Resorts & Cruise Lines' },
  ...
  AXP:   { sector: 'Financials',              industria: 'Consumer Finance' },
  BABA:  { sector: 'Consumer Discretionary',  industria: 'Broadline Retail' },
  BAC:   { sector: 'Financials',              industria: 'Diversified Banks' },
  BLK:   { sector: 'Financials',              industria: 'Asset Management & Custody Banks' },
  BN:    { sector: 'Financials',              industria: 'Asset Management & Custody Banks' },
  'BRK.B': { sector: 'Financials',           industria: 'Multi-Sector Holdings' },
  CAT:   { sector: 'Industrials',             industria: 'Construction Machinery & Heavy Equipment' },
  CB:    { sector: 'Financials',              industria: 'Property & Casualty Insurance' },
  CEG:   { sector: 'Utilities',               industria: 'Independent Power Producers' },
  CMG:   { sector: 'Consumer Discretionary',  industria: 'Restaurants' },
  ...
  CRWD:  { sector: 'Information Technology',  industria: 'Systems Software' },
  CVNA:  { sector: 'Consumer Discretionary',  industria: 'Specialty Retail' },
  CVX:   { sector: 'Energy',                  industria: 'Integrated Oil & Gas' },
  DPZ:   { sector: 'Consumer Discretionary',  industria: 'Restaurants' },
  GOOGL: { sector: 'Communication Services',  industria: 'Interactive Media & Services' },
  GS:    { sector: 'Financials',              industria: 'Investment Banking & Brokerage' },
  ISRG:  { sector: 'Health Care',             industria: 'Health Care Equipment' },
  JBS:   { sector: 'Consumer Staples',        industria: 'Packaged Foods & Meats' },
  JNJ:   { sector: 'Health Care',             industria: 'Pharmaceuticals' },
  JPM:   { sector: 'Financials',              industria: 'Diversified Banks' },
  KO:    { sector: 'Consumer Staples',        industria: 'Soft Drinks & Non-alcoholic Beverages' },
  LLY:   { sector: 'Health Care',             industria: 'Pharmaceuticals' },
  MA:    { sector: 'Financials',              industria: 'Transaction & Payment Processing Services' },
  MCD:   { sector: 'Consumer Discretionary',  industria: 'Restaurants' },
  ...
  NBIS:  { sector: 'Information Technology',  industria: 'Systems Software' },
  NFLX:  { sector: 'Communication Services',  industria: 'Entertainment' },
  NKE:   { sector: 'Consumer Discretionary',  industria: 'Apparel, Accessories & Luxury Goods' },
  NOW:   { sector: 'Information Technology',  industria: 'Systems Software' },
  ...
  OSCR:  { sector: 'Health Care',             industria: 'Managed Health Care' },
  PLTR:  { sector: 'Information Technology',  industria: 'Software' },
  PYPL:  { sector: 'Financials',              industria: 'Transaction & Payment Processing Services' },
  QCOM:  { sector: 'Information Technology',  industria: 'Semiconductors' },
  SBUX:  { sector: 'Consumer Discretionary',  industria: 'Restaurants' },
  SCHW:  { sector: 'Financials',              industria: 'Investment Banking & Brokerage' },
  SE:    { sector: 'Consumer Discretionary',  industria: 'Broadline Retail' },
  SHOP:  { sector: 'Information Technology',  industria: 'Internet Services & Infrastructure' },
  SNDK:  { sector: 'Information Technology',  industria: 'Technology Hardware & Peripherals' },
  SNOW:  { sector: 'Information Technology',  industria: 'Systems Software' },
  SPOT:  { sector: 'Communication Services',  industria: 'Entertainment' },
  SPCX:  { sector: 'Industrials',             industria: 'Aerospace & Defense' },
  TBBB:  { sector: 'Consumer Staples',        industria: 'Consumer Staples Distribution & Retail' },
  TSLA:  { sector: 'Consumer Discretionary',  industria: 'Automobile Manufacturers' },
  TSM:   { sector: 'Information Technology',  industria: 'Semiconductors' },
  UBER:  { sector: 'Industrials',             industria: 'Ground Transportation' },
  UNH:   { sector: 'Health Care',             industria: 'Managed Health Care' },
  V:     { sector: 'Financials',              industria: 'Transaction & Payment Processing Services' },
  WMT:   { sector: 'Consumer Staples',        industria: 'Consumer Staples Distribution & Retail' },
  XOM:   { sector: 'Energy',                  industria: 'Integrated Oil & Gas' },
  YPF:   { sector: 'Energy',                  industria: 'Integrated Oil & Gas' },
};
