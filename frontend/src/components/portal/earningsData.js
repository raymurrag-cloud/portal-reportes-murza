...
export const EARNINGS_DATA = {
  ...
  NFLX: {
    ...
    fecha_confirmada: false,
    eps_estimate: 5.74,
    revenue_estimate_b: 10.5,
    forward_pe: 31.2,
    last_surprise_pct: 5.8,
    what_to_watch: [
      'Suscriptores netos Q1: crecimiento de memberships tras eliminacion de password sharing — base total',
      'Revenue por usuario (ARM): sube con tier publicitario? — mix entre plan ads y plan premium',
      'Ad-supported tier: ingresos publicitarios como nuevo vector — timeline para ser material al P&L',
      'Contenido live: NFL games y eventos en vivo — diferenciacion vs Disney+ y Max',
      'Guidance Q2 y margen operativo: consolida el 28-30% de margen o sigue expandiendo',
    ],
  },
  ...
  ASML: {
    ...
    what_to_watch: [
      'Bookings de EUV y High-NA EUV: señal de demanda de TSMC, Samsung, Intel para nodos 2nm y menores',
      'Guidance 2026 revenue: reafirma rango de 30-35B euros? — revision tras debilidad de Samsung',
      'Instalaciones de High-NA: cuantos sistemas EXE:5000 entregados — precio unitario 380M euros',
      'China revenue: porcentaje del total y riesgo de restricciones adicionales de exportacion EU/US',
      'Cycle timing: cuando empieza el next upcycle de capex de semiconductores — backlog como señal',
    ],
  },
