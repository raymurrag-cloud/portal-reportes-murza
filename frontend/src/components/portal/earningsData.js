...
export const EARNINGS_DATA = {
  ...
  GS: {
    ...
    fecha_confirmada: false,
    eps_estimate: 14.50,
    revenue_estimate_b: 14.5,
    forward_pe: 13.8,
    last_surprise_pct: 6.2,
    what_to_watch: [
      'Investment Banking fees: recuperacion del pipeline M&A e IPOs en entorno de tasas mas estable',
      'Trading revenues FICC + Equities: volatilidad por aranceles pudo inflar ingresos de trading en Q2',
      'Asset & Wealth Management: crecimiento de AUM en alternativos y fee revenues recurrentes',
      'Net Interest Income: manejo del spread de depositos y costo de fondeo',
      'Capital returns: ritmo de recompras y progreso hacia CET1 objetivo ~13%',
    ],
  },
  ...
  BAC: {
    ...
    trimestre: 'Q2 2026',
    fecha: '2026-07-15T07:00:00',
    cuando: 'Antes de apertura',
    fecha_confirmada: false,
    eps_estimate: 0.87,
    revenue_estimate_b: 25.5,
    forward_pe: 11.2,
    last_surprise_pct: 4.8,
    what_to_watch: [
      'Net Interest Income: alta sensibilidad a recortes de Fed — cada -25bps impacta NII en ~$900M anualizado',
      'Consumer spending trends: volumenes de tarjeta de credito y comportamiento ante incertidumbre economica',
      'Calidad crediticia: charge-offs y provision para perdidas — indicador de salud del consumidor',
      'Investment Banking recovery: fees de mercados de capitales y M&A en comparacion con JPM y GS',
      'Depositos y cash sorting: estabilizacion de saldos en cuentas vs fondos del mercado de dinero',
    ],
  },
  ...
  BLK: {
    nombre: 'BlackRock',
    trimestre: 'Q2 2026',
    fecha: '2026-07-11T07:30:00',
    cuando: 'Antes de apertura',
    fecha_confirmada: false,
    eps_estimate: 11.60,
    revenue_estimate_b: 5.6,
    forward_pe: 18.2,
    last_surprise_pct: 3.9,
    what_to_watch: [
      'Net flows en iShares ETFs: flujos netos como indicador de captacion de mercado en renta fija y variable',
      'Technology segment (Aladdin): crecimiento de ingresos recurrentes — objetivo 15-20% YoY',
      'Integracion GIP (Global Infrastructure Partners): contribucion a AUM y revenues de alternativos',
      'Beta de mercado en AUM: mercados mas altos = mayores fees de gestion sobre la base de $10T+',
      'Operating leverage: expansion de margen operativo a escala; objetivo >40% a largo plazo',
    ],
  },

  SCHW: {
    nombre: 'Charles Schwab',
    trimestre: 'Q2 2026',
    fecha: '2026-07-17T08:00:00',
    cuando: 'Antes de apertura',
    fecha_confirmada: false,
    eps_estimate: 1.12,
    revenue_estimate_b: 5.1,
    forward_pe: 21.5,
    last_surprise_pct: 5.3,
    what_to_watch: [
      'Net Interest Revenue: principal driver — recuperacion del cash sorting (cliente volviendo de fondos a depositos)',
      'Cash sorting pace: saldo en bank sweep deposits vs money market funds — el viento de frente clave de 2023-24',
      'Asset management & administration fees: crecimiento en base de activos bajo gestion',
      'Nuevas cuentas de corretaje: indicador de crecimiento organico y captacion de nuevos clientes',
      'Costo de fondeo: normalizacion post-TD Ameritrade y tendencia de certificados de deposito',
    ],
  },
  ...
  UNH: {
    ...
    fecha_confirmada: false,
    eps_estimate: 7.60,
    revenue_estimate_b: 105.0,
    forward_pe: 18.5,
    last_surprise_pct: -8.5,
    what_to_watch: [
      'Medical Loss Ratio (MLR): KPI critico — cualquier deterioro adicional indica presion en Medicare Advantage',
      'Optum Health revenues: ~60% del profit operativo; crecimiento en servicios de salud y data analytics',
      'Guidance 2026: compania suspendio guidance en mayo-2026 — reinstatement o actualizacion es el evento clave',
      'Medicare Advantage enrollment trends: net member growth y prime de compensacion en nuevo ciclo de precios',
      'Investigacion DOJ: novedades sobre caso de fraude del ex-CEO y impacto en confianza institucional',
    ],
  },

  ISRG: {
    nombre: 'Intuitive Surgical',
    trimestre: 'Q2 2026',
    fecha: '2026-07-22T16:30:00',
    cuando: 'Despues del cierre',
    fecha_confirmada: false,
    eps_estimate: 2.15,
    revenue_estimate_b: 2.85,
    forward_pe: 55.0,
    last_surprise_pct: 6.7,
    what_to_watch: [
      'Crecimiento de procedimientos da Vinci: meta +15-17% YoY — el indicador de salud del negocio de uso',
      'Ion endoscopy placements: plataforma emergente de biopsia pulmonar con mayor TAM que da Vinci',
      'System placements: nuevas instalaciones de da Vinci 5 vs generacion anterior — premium en margen',
      'Gross margin: sostenibilidad ~67% en entorno de mayores costos de manufactura y mix de producto',
      'China procedures: riesgo regulatorio y competencia local; concentracion geografica a monitorear',
    ],
  },
  ...
  JNJ: {
    ...
    fecha_confirmada: false,
    eps_estimate: 2.70,
    revenue_estimate_b: 22.5,
    forward_pe: 16.8,
    last_surprise_pct: 3.5,
    what_to_watch: [
      'Innovative Medicine: crecimiento de Darzalex y Tremfya vs erosion de Stelara por biosimilares (~$10B en riesgo)',
      'MedTech segment: volumenes de procedimientos ortopedicos y electrofisiologia cardiovascular',
      'Pipeline oncologico: datos de Fase 3 para candidatos clave en mieloma multiple y cancer de pulmon',
      'Litigacion talco: progreso de acuerdos y resolucion del proceso de quiebra capitulo 11 de LTL',
      'FX impact: dolares fuerte presiona ~50% de ingresos internacionales; guia en moneda constante vs reportada',
    ],
  },
  ...
  NOW: {
    nombre: 'ServiceNow',
    trimestre: 'Q2 2026',
    fecha: '2026-07-23T16:30:00',
    cuando: 'Despues del cierre',
    fecha_confirmada: false,
    eps_estimate: 4.15,
    revenue_estimate_b: 3.05,
    forward_pe: 21.5,
    last_surprise_pct: 7.2,
    what_to_watch: [
      'cRPO (current Remaining Performance Obligations): indicador adelantado de revenue — objetivo +20% YoY',
      'Now Assist AI penetration: tasa de adopcion de productos IA en base instalada de enterprise customers',
      'Net new ACV y deals >$1M TCV: velocidad de nuevos contratos grandes como senal de expansion del mercado',
      'Operating margin guidance: expansion de margen hacia objetivo 2026 en contexto de inversion en IA',
      'International growth: Europa y Asia como motores de crecimiento frente a saturacion relativa en EEUU',
    ],
  },
  ...
  MCD: {
    nombre: "McDonald's",
    trimestre: 'Q2 2026',
    fecha: '2026-07-28T07:00:00',
    cuando: 'Antes de apertura',
    fecha_confirmada: false,
    eps_estimate: 3.10,
    revenue_estimate_b: 6.5,
    forward_pe: 22.5,
    last_surprise_pct: 2.8,
    what_to_watch: [
      'Comparable store sales globales: recuperacion post-slump de percepcion de valor — clave para re-rating',
      'Trafico vs ticket promedio: si el crecimiento es por volumen de clientes o solo por precio',
      'McValue platform: impacto del programa de valor en trafico de clientes vs compresion de margen',
      'Digital + Delivery GMV: ordenes mobile como % de ventas — objetivo de mayor personalizacion y frecuencia',
      'Mercados internacionales: comps en Europa y China en entorno de consumidor presionado',
    ],
  },
  ...
  SBUX: {
    nombre: 'Starbucks',
    trimestre: 'Q3 FY2026',
    fecha: '2026-07-29T16:30:00',
    cuando: 'Despues del cierre',
    fecha_confirmada: false,
    eps_estimate: 0.65,
    revenue_estimate_b: 9.3,
    forward_pe: 43.5,
    last_surprise_pct: -5.0,
    what_to_watch: [
      'Comparable store sales EEUU: turnaround Niccol — objetivo recuperar trafico; fue -4% en Q1 FY2026',
      'Transacciones por tienda: KPI de turnaround — crecimiento de clientes unicos vs ticket promedio',
      'Mobile Order & Pay: reduccion de tiempos de espera y mejora de experiencia como driver de frecuencia',
      'China comps: presion competitiva de Luckin Coffee y debilidad del consumidor chino',
      'Operating margin: normalizacion tras reinversion en labor, remodelaciones y cierre de 627 tiendas',
    ],
  },
  ...
  NKE: {
    nombre: 'Nike',
    trimestre: 'Q4 FY2026',
    fecha: '2026-06-25T16:30:00',
    cuando: 'Despues del cierre',
    fecha_confirmada: false,
    eps_estimate: 0.38,
    revenue_estimate_b: 11.8,
    forward_pe: 29.0,
    last_surprise_pct: 4.2,
    what_to_watch: [
      'Revenue trajectory: desaceleracion de la caida — FY2025 fue -9.8%; el mercado quiere ver piso en Q4',
      'Wholesale channel recovery: Nike volviendo a socios mayoristas tras error estrategico DTC-first 2020-2023',
      'China revenues: recuperacion de participacion de mercado vs Anta y Li-Ning en categoria running y basketball',
      'Gross margin: impacto de aranceles sobre produccion en Vietnam e Indonesia — riesgo materializandose en 2026',
      'FY2027 guidance: primera mirada al nuevo ciclo bajo CEO Hill — credibilidad del reset estrategico',
    ],
  },
  ...
  KO: {
    nombre: 'Coca-Cola',
    trimestre: 'Q2 2026',
    fecha: '2026-07-22T07:00:00',
    cuando: 'Antes de apertura',
    fecha_confirmada: false,
    eps_estimate: 0.73,
    revenue_estimate_b: 12.1,
    forward_pe: 23.5,
    last_surprise_pct: 3.1,
    what_to_watch: [
      'Organic revenue growth: mix de volumen vs precio/mix — recovery de volumen tras anos de alzas de precios',
      'Mercados emergentes: LatAm, Africa y Asia-Pacifico como motores; sensibilidad a tipo de cambio local',
      'Pricing power sostenible: elasticidad del consumidor tras +30% de precios acumulados desde 2020',
      'FX headwinds: dolares fuerte impacta ~70% de ingresos internacionales — diferencial GAAP vs moneda constante',
      'Programa de refranchising: avance en optimizacion de red de embotelladoras hacia modelo capital-light',
    ],
  },
