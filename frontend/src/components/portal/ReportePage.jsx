      ...
      <div className="portal-page">
        <header className="portal-header">
          ...
          <nav style={{ display: 'flex', gap: 2, alignItems: 'center' }}>
            <Link to="/" style={{ padding: '6px 11px', borderRadius: 8, fontSize: 13, color: 'var(--text-muted)', fontWeight: 500, textDecoration: 'none' }}
            ...
            <Link to="/earnings" style={{ padding: '6px 11px', borderRadius: 8, fontSize: 13, color: 'var(--text-muted)', fontWeight: 500, textDecoration: 'none' }}
              onMouseEnter={e => { e.currentTarget.style.background = 'var(--gold-pale)'; e.currentTarget.style.color = 'var(--gold-dark)'; }}
              onMouseLeave={e => { e.currentTarget.style.background = 'none'; e.currentTarget.style.color = 'var(--text-muted)'; }}>
              Earnings
            </Link>
            <Link to="/noticias" style={{ padding: '6px 11px', borderRadius: 8, fontSize: 13, color: 'var(--text-muted)', fontWeight: 500, textDecoration: 'none' }}
              onMouseEnter={e => { e.currentTarget.style.background = 'var(--gold-pale)'; e.currentTarget.style.color = 'var(--gold-dark)'; }}
              onMouseLeave={e => { e.currentTarget.style.background = 'none'; e.currentTarget.style.color = 'var(--text-muted)'; }}>
              Noticias
            </Link>
            <Link to={`/comparar?t=${reporte?.ticker || ''}`} style={{ padding: '6px 11px', borderRadius: 8, fontSize: 13, color: 'var(--text-muted)', fontWeight: 500, textDecoration: 'none' }}
              onMouseEnter={e => { e.currentTarget.style.background = 'var(--gold-pale)'; e.currentTarget.style.color = 'var(--gold-dark)'; }}
              onMouseLeave={e => { e.currentTarget.style.background = 'none'; e.currentTarget.style.color = 'var(--text-muted)'; }}>
              Comparar
            </Link>
            <Link to="/portafolio" style={{ padding: '6px 11px', borderRadius: 8, fontSize: 13, color: 'var(--text-muted)', fontWeight: 500, textDecoration: 'none' }}
              onMouseEnter={e => { e.currentTarget.style.background = 'var(--gold-pale)'; e.currentTarget.style.color = 'var(--gold-dark)'; }}
              onMouseLeave={e => { e.currentTarget.style.background = 'none'; e.currentTarget.style.color = 'var(--text-muted)'; }}>
              Portafolio
            </Link>
